...
5. **Continuer la centralisation documentaire** via `docs/instructions/README.md` (mis en place dans ce commit) et pointer les futurs guides (NOWNodes, MCP, etc.) vers ce hub.
